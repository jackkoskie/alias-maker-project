...
echo.
echo Generating Clearence/Delivery alias...
echo.

echo .on /%icao%_DEL is ONLINE on $freq. >%icao%_DEL_ALIAS.txt
echo .off /%icao%_DEL is now OFFLINE. >>%icao%_DEL_ALIAS.txt
echo. >>%icao%_DEL_ALIAS.txt
echo .atis ATIS Information "$atiscode" is now current in %name%. >>%icao%_DEL_ALIAS.txt
echo. >>%icao%_DEL_ALIAS.txt
echo ;DEL Stuff
echo .clear %icao% Flight Plan Clearence |$dep - $arr|SID: $sid|ROUTE: Flight Planed Route|DEP RWY: $deprwy|SQUAWK: $squawk|ATIS: $atiscode| >>%icao%_DEL_ALIAS.txt
echo .nosid %icao% Flight Plan Clearence |$dep - $arr|Fly Runway Heading, Climb 5000|ROUTE: Flight Planed Route|DEP RWY: $deprwy|SQUAWK: $squawk|ATIS: $atiscode| >>%icao%_DEL_ALIAS.txt
echo .read Read back correct contact ground on $freq[%icao%_GND] >>%icao%_DEL_ALIAS.txt
echo. >>%icao%_DEL_ALIAS.txt
echo ;ALIAS file generated by The Alias Maker Project ©2020 >>%icao%_DEL_ALIAS.txt

echo Alias file generated for %icao%_DEL
pause >nul
exit
...
echo .clear %icao% Flight Plan Clearence |$dep - $arr|SID: $sid|ROUTE: Flight Planed Route|DEP RWY: $deprwy|SQUAWK: $squawk|ATIS: $atiscode| >>%icao%_GND_ALIAS.txt
echo .nosid %icao% Flight Plan Clearence |$dep - $arr|Fly Runway Heading, Climb 5000|ROUTE: Flight Planed Route|DEP RWY: $deprwy|SQUAWK: $squawk|ATIS: $atiscode| >>%icao%_GND_ALIAS.txt
...
echo. >>%icao%_GND_ALIAS.txt
echo ;ALIAS file generated by The Alias Maker Project ©2020 >>%icao%_GND_ALIAS.txt
...
echo .clear %icao% Flight Plan Clearence |$dep - $arr|SID: $sid|ROUTE: Flight Planed Route|DEP RWY: $deprwy|SQUAWK: $squawk|ATIS: $atiscode| >>%icao%_TWR_ALIAS.txt
echo .nosid %icao% Flight Plan Clearence |$dep - $arr|Fly Runway Heading, Climb 5000|ROUTE: Flight Planed Route|DEP RWY: $deprwy|SQUAWK: $squawk|ATIS: $atiscode| >>%icao%_TWR_ALIAS.txt
...
echo. >>%icao%_TWR_ALIAS.txt
echo ;ALIAS file generated by The Alias Maker Project ©2020 >>%icao%_TWR_ALIAS.txt
